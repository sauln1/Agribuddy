...
# ── Legacy aliases ─────────────────────────────────────────────────────────
# Older code paths still reference Flora/APIFarmer/Perenual constants;
...
APIFARMER_DETAILS_ENDPOINT      = VERDANTLY_SEARCH_ENDPOINT  # Verdantly has no detail endpoint
...
MANUAL_EVENT_TYPES = [
    EVENT_WATERED, EVENT_FERTILIZED,
    EVENT_PEST, EVENT_BLIGHT, EVENT_SNOW,
    EVENT_HARVESTED, EVENT_TRANSPLANTED, EVENT_SPROUTED,
    EVENT_DEAD, EVENT_OTHER,
]
